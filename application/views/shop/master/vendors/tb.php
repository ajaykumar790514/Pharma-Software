        ...
        <table>
            ...
            <tr class="jsgrid-filter-row">
                ...
                <td class="jsgrid-cell jsgrid-align-center" id="status<?php echo $value->sup_id; ?>">
                 ...
                 <button class="btn btn-success btn-sm" onclick="change_status(<?php echo $value->sup_id;?>)">Active</button>
                 <?php } else {?>
                 <button class="btn btn-danger btn-sm   " onclick="change_status(<?php echo $value->sup_id;?>)">Inactive</button>
                <?php }?>
                 </td>
                <td class="jsgrid-cell jsgrid-align-center">
                    

                    <a href="javascript:void(0)" data-toggle="modal" data-target="#showModal" data-whatever="Update Supplier ( <?=$value->name?> )" data-url="<?=$update_url?><?=$value->sup_id?>" >
...
<script>
   ...
   $('#delete_all').click(function(){
        ...
        var table = 'customers';
            ...
            $.ajax({
                url:"<?php echo base_url(); ?>shop-master-data/multiple_delete_supplier",
                method:"POST",
