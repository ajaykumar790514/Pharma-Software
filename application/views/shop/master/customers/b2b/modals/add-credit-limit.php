...
<div class="modal fade" id="customerDetailModal" tabindex="-1" role="dialog" aria-labelledby="customerDetailModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url('shop-customer-b2b/set_credit_limit') ?>" method="post" style="width: 100%;" onsubmit="return changeCustomerB2BCreditLimit('pan-form')" id="pan-form">
