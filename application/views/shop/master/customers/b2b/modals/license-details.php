  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="customerDetailModalLabel">License Details</h5>
        ...
        <div class="row">
          <div class="col-12">
            <table class="table table-responsive table-secondary">
              ...
              <tr>
                <th>License No</th>
                <td><?php echo $customer->license_no ?? ''; ?></td>
              </tr>
              <tr>
                <th>License Expiry</th>
                <td><?php echo $customer->license_expiry ?? ''; ?></td>
              </tr>
              <tr>
                <th>License Document</th>
                <td><img src="<?=base_url('assets/photo/'.$customer->license_doc);?>" alt="" width="50" height="50" data-bs-toggle="modal" data-bs-target="#exampleModal1">
                        <img src="<?=base_url('assets/photo/'.$customer->license_doc2);?>" alt="" width="50" height="50" data-bs-toggle="modal" data-bs-target="#exampleModal2"></td>
                           <!-- Image 1 -->
      ...
      <div class="modal-footer">
        <form action="<?php echo base_url('shop-customer-b2b/change_status') ?>" method="post" style="width: 100%;" onsubmit="return changeCustomerB2BStatus('license-form')" id="license-form">
          <input type="hidden" id="customer_id" value="<?php echo $customer->customer_id ?>">
          <input type="hidden" id="customer_detail_type" value="license">
