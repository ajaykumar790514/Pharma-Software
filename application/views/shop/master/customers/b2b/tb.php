                                 ...
                                 <i class="fa fa-image" style="color:blue;margin-left:0.1rem;cursor:pointer" data-bs-toggle="modal" title="View document  front image" data-bs-target="#exampleModal1<?php echo $i;?>"></i>
                                   ...
                                   <i class="fa fa-image" title="View document back image" style="color:blue;margin-left:0.1rem;cursor:pointer" data-bs-toggle="modal"  data-bs-target="#exampleModal2<?php echo $i;?>"></i>
                                                    ...
                                                    <td class="jsgrid-cell jsgrid-align-center">
                                                       ...
                                                       <a herf="" onclick="return display_details(<?php echo $customer->customer_id; ?>, '<?php echo base_url('shop-customer-b2b/add-credit-limit') ?>')" style="color:blue;font-size:1rem;cursor:pointer"><i class="fa fa-plus" aria-hidden="true" title="Credit"></i></a>
                                                    </td>
                                                    <td  class="jsgrid-cell jsgrid-align-center">
                                                        <button class="btn <?php echo get_customer_button_class($customer->business_status); ?>" onclick="return display_details(<?php echo $customer->customer_id; ?>, '<?php echo base_url('shop-customer-b2b/busines-detail') ?>')">GST</button>
                                                        <button class="btn <?php echo get_customer_button_class($customer->pan_status); ?> my-1" onclick="return display_details(<?php echo $customer->customer_id; ?>, '<?php echo base_url('shop-customer-b2b/pan-detail') ?>')">Pan</button>
                                                        </td>
                                                        <td style="display: flex;" class="jsgrid-cell jsgrid-align-center">
                                                        <!-- <button class="btn mt-1  <?php // echo get_customer_button_class($customer->license_status); ?>" onclick="return display_details(<?php // echo $customer->customer_id; ?>, '<?php // echo base_url('shop-customer-b2b/license-detail') ?>')">License</button> -->
                                                        <a style="margin-left:-5px ;" href="<?=base_url('shop-customer-b2b/license/'.$customer->customer_id.'/'.$menu_id);?>" class="mt-3 btn btn-primary text-white">License</a>
                                                        <a href="<?=base_url('shop-customer-b2b/lazer/'.$customer->customer_id.'/'.$menu_id);?>" class="ml-2  mt-3 btn btn-success text-white">Leazer</a>
                                                        </td>
                                                    </td>
                                                    <!-- <td><center><button class="btn btn-primary" onclick="return display_details(<?php echo $customer->customer_id; ?>, '<?php echo base_url('shop-customer-b2b/verify-detail') ?>')">Click Here</button></center></td> -->
                                                </tr>
                                            <?php }
                                            ?>
