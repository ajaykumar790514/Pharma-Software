                     ...
                     <div class="col-md-12 p-0">
                      <table class="table table-sm table-bordered text-right mb-0">
                        <tbody>
                         ...
                         <input type="number" id="flatDiscount" oninput="calculate_amount()" name="flatDiscount" onkeydown="check(event,this)"  class="form-control form-control-sm rounded-0 flatDiscount col-3 text-right" value="0"    >
