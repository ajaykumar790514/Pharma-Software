...
<form class="add_product needs-validation reload-tb" action="<?=base_url('purchase/add-new-product');?>" method="post">
        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control code" name="product_code" value="<?=$code;?>" >
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="form-group">
                    ...
                    <textarea id="editor3" cols="92" rows="5" class="form-control" name="description"></textarea>
                </div>
            </div>
        </div>
   ...
   <input type="hidden" name="NewOfferValue" id="NewOfferValue" class="NewOfferValue">
        ...
        <div class="row">
            <div class="col-12">
                <table id="propertyTable2" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>S.No.</th>
                            <th>Property Name</th>
        ...
        <div class="col-5">
            <div class="form-group">
                ...
                <select class="form-control" id="prop_value3" name="prop_value3" style="width:100%;display:none;">
...
function addProperty() {
    ...
    var prop_type = $('#prop_value3').val().split(',');
    var prop_typeID = prop_type[0];
    var prop_typeName = prop_type[1];
    
    // Check if the property already exists
    var exists = false;
    $('#propertyTable2 tbody tr').each(function() {
    ...
    var rowCount = $('#propertyTable2 tbody tr').length + 1;
    var newRow = '<tr>' +
        ...
        '</tr>';
    $('#propertyTable2 tbody').append(newRow);
    $('#valueinput').val('');
}
        ...
        if (type == 2 || type == 3) {
            ...
            $.ajax({
                ...
                success: function(data){
                    console.log(data);
                    $("select[name='prop_value3']").html(data);
                },
            });
        }else{
            $("select[name='prop_value3']").hide();
            $("#valueinput").show();
        }
    }
