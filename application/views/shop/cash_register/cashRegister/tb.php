        ...
        <table class="jsgrid-table" id="Bankable">
            ...
            ?>
                <tr class="jsgrid-filter-row">
                    ...
                    <td class="jsgrid-cell jsgrid-align-center">
                    <?php if($value->user_type=='customer'){ echo ($value->customer_name) ? $value->customer_name : $value->bank_name;}elseif($value->user_type=='supplier'){ echo ($value->supplier_name) ? $value->supplier_name : $value->bank_name;}else{ echo ($value->customer_name) ? $value->customer_name : $value->bank_name;}; ?></td></td>
