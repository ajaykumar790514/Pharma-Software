  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <form action="<?php echo base_url('customers-b2b/change_status') ?>" method="post" style="width: 100%;" onsubmit="return changeCustomerB2BStatus('license-form')" id="license-form">
