...
<div class="row page-titles">
    <div class="col-md-10 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('customers-b2b/'.$menu_id); ?>">Customer Data -  License</a></li>
            <li class="breadcrumb-item active">Customer B2B - License</li>
            <li class="breadcrumb-item text-danger active"><?=@$customer->fname.' '.@$customer->mname.' '.@$customer->lname;?></li>
        </ol>
    </div>
    <!-- <div class="col-md-2"></div> -->
    <div class="col-md-2 mt-3">
        <a href="<?=base_url('customers-b2b/'.$menu_id);?>" class="btn btn-danger">Back</a>
    </div>
</div>
<!-- ============================================================== -->
