...
<div class="row page-titles">
    <div class="col-md-5 col-8 align-self-center">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Upload Products Excel</li>
        </ol>
    </div>
</div>
<!-- ============================================================== -->
        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-wrap">
                            <div class="float-left col-md-6 col-lg-6 col-sm-6">
                                <h3 class="card-title" id="test">Upload Products Data </h3>
                                <h6 class="card-subtitle"></h6>
                                </div>
                                <div class="float-right col-md-6 col-lg-6 col-sm-6">
                                <a class="float-right btn  btn-sm btn-danger" href="<?php echo base_url('products/'.$menu_id);?>">Back</a>
                            </div>
                        </div>
                      </div>
                      <div class="col-4"></div>
                    ...
                    <div class="col-4"></div>
                    <div class="col-12 d-none product_details">
                    ...
                    success: function (data) {
                        ...
                        try {
                            ...
                            if (parsedData.res == 'success') {
                                ...
                                $('#products').html(parsedData.table);
                                $("#myForm")[0].reset();
                            } else {
                                Swal.fire({
                                    icon: 'error',
