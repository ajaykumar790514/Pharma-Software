        ...
        <?php } ?>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="file" id="productImage" name="application" class="form-control">
                </div>
            ...
            <div class="col-6">
                <div class="form-group">
                    ...
                    <input type="file" id="productImage1" name="img[]" class="form-control"
...
<script type="text/javascript">
    ...
    // Bind file size check to the file input field
    $('#productImage1').on('change', checkFileSize1);
