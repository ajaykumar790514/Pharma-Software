                                    ...
                                    <div class="col-12">
                                        <div class="d-flex flex-wrap">
                                            <div class="float-left col-md-10 col-lg-10 col-sm-12">
                                                <h3 class="card-title" id="test">Company Master Data</h3>
                                            ...
                                            <div class="float-right col-md-2 col-lg-2 col-sm-12">
                                                ...
                                                <button class="float-right btn btn-primary" data-toggle="modal" data-target="#add-brand" >Add Company</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div id="grid_table">
                                            <table class="jsgrid-table">
                                                <tr class="jsgrid-header-row">
                                                    ...
                                                    <th class="jsgrid-header-cell jsgrid-align-center">Company Name</th>
