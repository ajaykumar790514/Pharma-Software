...
$route['orders/(:num)'] = 'orders/order';
$route['orders/(:any)'] = 'orders/order/$1';
$route['orders/(:any)/(:any)'] = 'orders/order/$1/$2';
$route['orders/(:any)/(:any)/(:any)'] = 'orders/order/$1/$2/$3';
...
$route['products/(:any)/(:any)/(:any)/(:any)/(:any)/(:num)/(:num)'] 	= 'master/products/$1/$2/$3/$4/$5/$6/$7';
$route['products/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)'] 	= 'master/products/$1/$2/$3/$4/$5/$6/$7';
$route['products/(:any)/(:any)/(:any)/(:any)/(:any)/(:num)/(:num)/(:num)'] 	= 'master/products/$1/$2/$3/$4/$5/$6/$7/$8';
...
$route['import-excel-data/(:num)'] 								= 'master/importExcelData';
$route['import-excel-data/(:any)'] 						= 'master/importExcelData/$1';
$route['import-excel-data/(:any)/(:num)'] 				= 'master/importExcelData/$1/$2';
$route['import-excel-data/(:any)/(:num)/(:num)'] 		= 'master/importExcelData/$1/$2/$3';
$route['import-excel-data/(:any)/(:num)/(:num)/(:num)'] 	= 'master/importExcelData/$1/$2/$3/$4';
...
$route['Import-excel-inventory/(:num)'] 						= 'master/importExcelInventoryData';
$route['Import-excel-inventory/(:any)'] 						= 'master/importExcelInventoryData/$1';
$route['Import-excel-inventory/(:any)/(:any)'] 				    = 'master/importExcelInventoryData/$1/$2';


$route['ingredient/(:num)'] = 'master/ingredient';
$route['ingredient/(:any)'] = 'master/ingredient/$1';
$route['ingredient/(:any)/(:num)'] = 'master/ingredient/$1/$2';
$route['ingredient/(:any)/(:num)/(:num)'] = 'master/ingredient/$1/$2/$3';
$route['ingredient/(:any)/(:num)/(:num)/(:num)'] = 'master/ingredient/$1/$2/$3/$4';
...
$route['customers-b2b/(:num)'] = 'customers/customers_b2b_list';
$route['customers-b2b/(:any)'] = 'customers/customers_b2b_list/$1';
$route['customers-b2b/(:any)/(:any)'] = 'customers/customers_b2b_list/$1/$2';
$route['customers-b2b/(:any)/(:any)/(:any)'] = 'customers/customers_b2b_list/$1/$2/$3';
// $route['customers-b2b/(:any)/(:any)/(:any)'] = 'customers/customers_b2b_list/$1/$2/$3';
// $route['customers-b2b/(:any)/(:any)/(:any)/(:any)'] = 'customers/customers_b2b_list/$1/$2/$3/$4';
$route['customers-b2b/busines-detail'] = 'customers/customer_b2b_business_details';
$route['customers-b2b/pan-detail'] = 'customers/customer_b2b_pan_details';
$route['customers-b2b/license-detail'] = 'customers/customer_b2b_license_details';
$route['customers-b2b/change_status'] = 'customers/customer_b2b_change_status';
$route['customers-b2b/add-credit-limit'] = 'customers/add_credit_limit';
// $route['customers-b2b/verify-detail'] = 'customers/customer_b2b_verify_status';
...
$route['bank-register/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)']		= 'Cash_register/bank/$1/$2/$3/$4/$5/$6';
$route['bank-register/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)']		= 'Cash_register/bank/$1/$2/$3/$4/$5/$6/$7';
...
$route['cash-register/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)']		= 'Cash_register/cash/$1/$2/$3/$4/$5/$6';
$route['cash-register/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)']		= 'Cash_register/cash/$1/$2/$3/$4/$5/$6/$7';
...
$route['expense/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)']		= 'Cash_register/expense/$1/$2/$3/$4/$5/$6';
$route['expense/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)/(:any)']		= 'Cash_register/expense/$1/$2/$3/$4/$5/$6/$7';
...
$route['shop-customer-b2b/(:num)'] = 'master_shop/customers_b2b_list';
$route['shop-customer-b2b/(:any)'] = 'master_shop/customers_b2b_list/$1';
$route['shop-customer-b2b/(:any)/(:any)'] = 'master_shop/customers_b2b_list/$1/$2';
$route['shop-customer-b2b/(:any)/(:any)/(:any)'] = 'master_shop/customers_b2b_list/$1/$2/$3';
$route['shop-customer-b2b/busines-detail'] = 'master_shop/customer_b2b_business_details';
$route['shop-customer-b2b/pan-detail'] = 'master_shop/customer_b2b_pan_details';
$route['shop-customer-b2b/license-detail'] = 'master_shop/customer_b2b_license_details';
$route['shop-customer-b2b/change_status'] = 'master_shop/customer_b2b_change_status';
$route['shop-customer-b2b/add-credit-limit'] = 'master_shop/add_credit_limit';
// expense